...
module maoin_mm_interconnect_0 (
	...
	wire  [16:0] led0_s1_agent_m0_address;                                                  // led0_s1_agent:m0_address -> led0_s1_translator:uav_address
	...
	wire  [93:0] led0_s1_agent_rf_source_data;                                              // led0_s1_agent:rf_source_data -> led0_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] led0_s1_agent_rsp_fifo_out_data;                                           // led0_s1_agent_rsp_fifo:out_data -> led0_s1_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> led0_s1_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> led0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // led0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> led0_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> led0_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> led0_s1_agent:cp_endofpacket
	...
	wire         led0_s1_agent_rp_valid;                                                    // led0_s1_agent:rp_valid -> router_005:sink_valid
	wire  [92:0] led0_s1_agent_rp_data;                                                     // led0_s1_agent:rp_data -> router_005:sink_data
	wire         led0_s1_agent_rp_ready;                                                    // router_005:sink_ready -> led0_s1_agent:rp_ready
	wire         led0_s1_agent_rp_startofpacket;                                            // led0_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         led0_s1_agent_rp_endofpacket;                                              // led0_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         led0_s1_agent_rdata_fifo_src_valid;                                        // led0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] led0_s1_agent_rdata_fifo_src_data;                                         // led0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         led0_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_003:in_0_ready -> led0_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                         // avalon_st_adapter_003:out_0_valid -> led0_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> led0_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                         // led0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                         // avalon_st_adapter_003:out_0_error -> led0_s1_agent:rdata_fifo_sink_error
	...
	maoin_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	maoin_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	maoin_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
